...
docker run -d --name postgres_sea_alertmanager -e POSTGRES_USER=user -e POSTGRES_PASSWORD=password -e POSTGRES_DB=database -p 127.0.0.1:5434:5432 -v ${PWD}/postgres_sea_data:/var/lib/postgresql/data postgres
```
